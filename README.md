...
<html lang="en">
  <head>
    <link rel="stylesheet" href="./bioIncludes/App.css" />
  ...
  <body>
      ...
      <div class="special-global-wrapper">
        <div class="blueBackground">
          ...
          <div class="blue-wrapper">
            ...
            <p>
              I have 15+ years of working with React/Node and the Lamp stack. If either works for you, I'm your guy.
            </p>
    ...
    <div class="blue" id="projects">
      <div class="special-global-wrapper">
		...
		<div class="special-global-wrapper" id="skills2">
			<div class="skills-title">Examples of my code</div>
        <div class="carousel2">
          <div class="slider2">
            <section>
              <span class="people-header">
          ...
          <div class="controls2">
            <span class="arrow left2"
              ><img src="bioIncludes/pics/chevron-left.png"
            /></span>
            <span class="arrow right2"
              ><img src="bioIncludes/pics/chevron-right.png"
            /></span>
            <ul>
			...
			<div class="skills-title">Things I know about</div>
				<section class="skills-section">
					<div class="icon-wrapper">
						<div>
							<img alt="react" src="./bioIncludes/skills/1.jpeg" />
						</div>
						<div>React</div>
					</div>
					...
					<div class="icon-wrapper">
						<div>
							<img alt="node js" src="./bioIncludes/skills/2.jpeg" />
						</div>
						<div>NodeJS</div>
					</div>
					...
					<div class="icon-wrapper">
						<div>
							<img alt="mongo" src="./bioIncludes/skills/3.jpeg" />
						</div>
						<div>Mongo</div>
					</div>
				</section>
